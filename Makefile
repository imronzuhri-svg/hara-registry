...
help:
	...
	@echo "  make up            Start hara-registry services (chain + RPC + signer + indexer)"
	@echo "  make down          Stop hara-registry services (data persists)"
	@echo "  make logs          Tail logs from hara-registry services"
	...
	@echo "  make clean         Stop and DESTROY hara-registry data (chain reset)"
	@echo ""
